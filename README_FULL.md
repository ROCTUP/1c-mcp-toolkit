...
Прокси предоставляет восемь MCP-инструментов (или девять при включённой анонимизации с инструментом `submit_for_deanonymization`) для взаимодействия с 1С:Предприятие:
